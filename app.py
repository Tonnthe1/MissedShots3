...
app.config['MAIL_USERNAME'] = 'missedshots.noreply@gmail.com'  # Replace with your email
app.config['MAIL_PASSWORD'] = 'pkfs iahq bcbn qgze'  # Replace with your email password
mail = Mail(app)
...
def send_password_email(email, password):
    msg = Message('Your Account Password', sender='your_email@example.com', recipients=[email])
    msg.body = f'Thank you for signing up. Your password is: {password}'
    mail.send(msg)
